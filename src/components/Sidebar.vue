										...
										<div class="relative mt-1">
											...
											>
												<ListboxOption
													...
													:value="source"
												>
													<li class="px-3 py-1" :class="{ 'bg-discord-weeby-500 text-gray-200': active }">
								...
								<li v-for="(file, fileId) in category.files" :key="fileId">
									<router-link
										...
										class="
											...
											rounded-sm
											hover:border-l-4 hover:border-discord-weeby-500 hover:text-gray-800
										...
										"
										exact-active-class="border-l-4 border-discord-weeby-530 text-gray-900"
										@click="isOpen = false"
									>
							...
							<li v-for="cls in visibleClasses" :key="cls.name">
								<router-link
									...
									class="
										...
										focus-visible:ring-1 focus-visible:ring-white
									"
									exact-active-class="border-l-4 border-discord-weeby-200 text-gray-900"
									@click="isOpen = false"
								>
