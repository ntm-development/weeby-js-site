		...
		<div class="flex items-center">
			<h3 class="inline-block mr-2">
				<router-link :to="{ name: 'docs-source-tag-class-class', query: { scrollTo } }">
					.{{ method.name }}(<span
						...
						:key="param.name"
						class="method-param text-discord-weeby-100 dark:text-discord-700 opacity-90 dark:opacity-75"
			...
			<span class="space-x-2 text-gray-200 text-sm font-semibold uppercase pt-6">
				<span
					...
					class="inline-flex items-center px-2.5 py-0.5 rounded-md bg-discord-weeby-100"
					>Static</span
				>
				<span v-if="method.abstract" class="inline-flex items-center px-2.5 py-0.5 rounded-md bg-discord-weeby-100"
					>Abstract</span
				>
