		...
		<div class="flex items-center">
			...
			<span class="space-x-2 text-gray-200 text-sm font-semibold uppercase pt-6">
				<span
					...
					class="inline-flex items-center px-2.5 py-0.5 rounded-md bg-discord-weeby-500"
					>Static</span
				>
				<span v-if="prop.readonly" class="inline-flex items-center px-2.5 py-0.5 rounded-md bg-discord-weeby-500"
					>Read-only</span
				>
